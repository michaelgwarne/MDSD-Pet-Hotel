 ...
 * @generated
 */
public class MdsdBookingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MdsdBookingPackage.BOOKING_CONTROLLER: {
				BookingController bookingController = (BookingController)theEObject;
				T result = caseBookingController(bookingController);
				if (result == null) result = caseUserBooking(bookingController);
				if (result == null) result = caseStaffBooking(bookingController);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdBookingPackage.SERVICE: {
				Service service = (Service)theEObject;
				T result = caseService(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdBookingPackage.USER_BOOKING: {
				UserBooking userBooking = (UserBooking)theEObject;
				T result = caseUserBooking(userBooking);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdBookingPackage.STAFF_BOOKING: {
				StaffBooking staffBooking = (StaffBooking)theEObject;
				T result = caseStaffBooking(staffBooking);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdBookingPackage.MEAL: {
				Meal meal = (Meal)theEObject;
				T result = caseMeal(meal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdBookingPackage.BOOKING: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>User Booking</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>User Booking</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUserBooking(UserBooking object) {
		return null;
	}
