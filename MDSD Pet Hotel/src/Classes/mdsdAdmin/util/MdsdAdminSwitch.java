 ...
 * @generated
 */
public class MdsdAdminSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MdsdAdminPackage.ADMIN_CONTROLLER: {
				AdminController adminController = (AdminController)theEObject;
				T result = caseAdminController(adminController);
				if (result == null) result = caseAdmin(adminController);
				if (result == null) result = caseBookingToAdmin(adminController);
				if (result == null) result = caseStaff(adminController);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdAdminPackage.HOTEL_STAFF: {
				HotelStaff hotelStaff = (HotelStaff)theEObject;
				T result = caseHotelStaff(hotelStaff);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdAdminPackage.ADMIN: {
				Admin admin = (Admin)theEObject;
				T result = caseAdmin(admin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdAdminPackage.BOOKING_TO_ADMIN: {
				BookingToAdmin bookingToAdmin = (BookingToAdmin)theEObject;
				T result = caseBookingToAdmin(bookingToAdmin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdsdAdminPackage.STAFF: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Booking To Admin</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Booking To Admin</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBookingToAdmin(BookingToAdmin object) {
		return null;
	}
