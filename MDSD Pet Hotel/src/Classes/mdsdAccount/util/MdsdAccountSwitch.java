 ...
 * @generated
 */
public class MdsdAccountSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MdsdAccountPackage.BOOKING_TO_ACCOUNT: {
				BookingToAccount bookingToAccount = (BookingToAccount)theEObject;
				T result = caseBookingToAccount(bookingToAccount);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Booking To Account</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Booking To Account</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBookingToAccount(BookingToAccount object) {
		return null;
	}
