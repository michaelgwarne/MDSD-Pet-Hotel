...
public class ClassesFactoryImpl extends EFactoryImpl implements ClassesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ClassesPackage.ACCOUNT: return createAccount();
			case ClassesPackage.PET: return createPet();
			case ClassesPackage.CUSTOMER: return createCustomer();
			case ClassesPackage.ACCOUNT_CONTROLLER: return createAccountController();
			default:
